...
function bones_login_css() {
    ...
    echo '<link rel="stylesheet" href="' . get_stylesheet_directory_uri() . '/stylesheets/login.css">';
}
...
function bones_register_sidebars() {
    register_sidebar(array(
        'id' => 'right-feature',
        'name' => 'Right Sidebar Feature',
        'description' => 'Used on feature article pages.',
    ...
    register_sidebar(array(
        'id' => 'right-album',
        'name' => 'Right Sidebar Album',
        'description' => 'Used on album article pages.',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>'
    ));
...
{ 
    ...
    wp_register_style( 'foundation', get_template_directory_uri() . '/stylesheets/foundation.min.css', array(), '3.1', 'all' );
...
$url = 'http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js'; // the URL to check against  
$test_url = @fopen($url,'r'); // test parameters  
if( $test_url !== false ) { // test if the URL exists  

    function load_external_jQuery() { // load external file  
        wp_deregister_script( 'jquery' ); // deregisters the default WordPress jQuery  
        wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js', __FILE__, false, '1.8.2', true); // register the external file  
    ...
    function load_local_jQuery() {  
        ...
        wp_register_script('jquery', bloginfo('template_url').'/javascripts/jquery.min.js', __FILE__, false, '1.8.2', true); // register the local file  
...
function modernize_it(){
    wp_register_script( 'modernizr', get_template_directory_uri() . '/javascripts/modernizr.foundation.js' ); 
...
function foundation_js(){
    wp_register_script( 'jquery-placeholder', get_template_directory_uri() . '/javascripts/jquery.placeholder.js', 'jQuery', '2.0.1', true ); 
    wp_enqueue_script( 'jquery-placeholder' );
    //wp_register_script( 'foundation-accordion', get_template_directory_uri() . '/javascripts/jquery.foundation.accordion.js' ); 
    //wp_enqueue_script( 'foundation-accordion', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-alerts', get_template_directory_uri() . '/javascripts/jquery.foundation.alerts.js' ); 
    //wp_enqueue_script( 'foundation-alerts', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-buttons', get_template_directory_uri() . '/javascripts/jquery.foundation.buttons.js' ); 
    //wp_enqueue_script( 'foundation-buttons', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-forms', get_template_directory_uri() . '/javascripts/jquery.foundation.forms.js' ); 
    //wp_enqueue_script( 'foundation-forms', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-mediaQueryToggle', get_template_directory_uri() . '/javascripts/jquery.foundation.mediaQueryToggle.js' ); 
    //wp_enqueue_script( 'foundation-mediaQueryToggle', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-navigation', get_template_directory_uri() . '/javascripts/jquery.foundation.navigation.js' ); 
    //wp_enqueue_script( 'foundation-navigation', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-orbit', get_template_directory_uri() . '/javascripts/jquery.foundation.orbit.js' ); 
    //wp_enqueue_script( 'foundation-orbit', 'jQuery', '1.4.0', true );
    //wp_register_script( 'foundation-reveal', get_template_directory_uri() . '/javascripts/jquery.foundation.reveal.js' ); 
    //wp_enqueue_script( 'foundation-reveal', 'jQuery', '1.1', true );
    //wp_register_script( 'foundation-tabs', get_template_directory_uri() . '/javascripts/jquery.foundation.tabs.js' ); 
    //wp_enqueue_script( 'foundation-tabs', 'jQuery', '1.0', true );
    //wp_register_script( 'foundation-tooltips', get_template_directory_uri() . '/javascripts/jquery.foundation.tooltips.js' ); 
    //wp_enqueue_script( 'foundation-tooltips', 'jQuery', '2.0.1', true );
    //wp_register_script( 'foundation-topbar', get_template_directory_uri() . '/javascripts/jquery.foundation.topbar.js' ); 
    //wp_enqueue_script( 'foundation-topbar', 'jQuery', '2.0.1', true );

    wp_register_script( 'app', get_template_directory_uri() . '/javascripts/app.js', 'jQuery', '1.0', true ); 
...
// ** Auto Excerpt [Required] **
 function auto_excerpt($content, $num_chars) {
    $excerpt = substr($content, 0, $num_chars);
    $excerpt = substr($excerpt, 0, strrpos($excerpt, " ", -1));
    echo $excerpt . "...";
 }

// ** Auto Character Limit **
